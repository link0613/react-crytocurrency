...
import { ScatterChart, Scatter, Cell, XAxis, YAxis, CartesianGrid, Tooltip, Legend, AreaChart, Area, ResponsiveContainer, Treemap  } from 'recharts';
...
class CorrelationB extends React.Component {
	render () {
	  	return (
	  		<div>
